...
class _Add_creenState extends State<Add_creen> {
  ...
  TimeOfDay selectedTime = TimeOfDay.now(); // Default to the current time
      ...
      children: [
        ElevatedButton(
          ...
          onPressed: () {
            ...
            String formattedTime = DateFormat('HH:mm').format(data);
            Firestore_Datasource()
                  .AddNote(subtitle.text, title.text, indexx, formattedTime);
